...
1. Just compression and download the entire */usr/share/grafana* directory by SFTP 
2. Export Grafana's database [Refer docs](https://grafana.com/docs/installation/upgrading/#database-backup)
