...
These accounts are required for Grafana image installation and configuration
...
You can use the **SSH** to run the command `cat /credentials/password.txt` to get the password
