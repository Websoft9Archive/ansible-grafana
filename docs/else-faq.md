...
#### Grafana support multi-language?

Yes

#### Where is the database connection configuration of Grafana?

Database configuration information in *metabase.conf* in the Grafana installation directory, [refer to the installation directory](/stack-components.md#metabase)
...
#### Is it possible to modify the source path of Grafana?
